...
Last updated: 5-Apr-2021 by Ashwin Agarwal
Version: 21.1.1
Feature added: DBDOC-2458 - Do not include the lab number in relative urls
+ DBDOC-2564 - Highlighting monospace font
+ Fixed issue with next and previous links.
+ Enabled capability to open labs in new tab (from TOC as well).
*/
